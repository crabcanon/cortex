...
class DocumentArtifactRepository:
    ...
    def add_many(self, records: list[DocumentArtifactRecord]) -> None:
        models = [
            DocumentArtifactModel(
                document_id=record.document_id,
                artifact_type=record.artifact_type,
...
class DocumentTagRepository:
    ...
    def add_many(self, records: list[DocumentTagRecord]) -> None:
        models = [
            DocumentTagModel(
                document_id=record.document_id,
                tag=record.tag,
...
class DocumentChunkRepository:
    ...
    def add_many(self, records: list[DocumentChunkRecord]) -> None:
        models = [
            DocumentChunkModel(
                chunk_id=record.chunk_id,
                document_id=record.document_id,
...
class ParseRunAttemptRepository:
    ...
    def add_many(self, records: list[ParseRunAttemptRecord]) -> None:
        models = [
            ParseRunAttemptModel(
                parse_run_id=record.parse_run_id,
                attempt_no=record.attempt_no,
