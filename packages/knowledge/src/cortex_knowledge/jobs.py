...
class KnowledgeJobControlService:
    ...
    async def record_failed(
        ...
        *,
        ...
        error_code = getattr(error, "code", None) or "knowledge_worker_failed"
    ...
    async def _append_event(
        ...
        *,
        ...
        # Performance optimization: Use database-level max aggregation instead of loading
        # potentially 1,000 job events into memory to determine the next sequence number.
