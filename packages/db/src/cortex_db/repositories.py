...
class JobEventRepository:
    ...
    async def get_max_sequence_no_for_job(self, job_id: str) -> int:
        # ⚡ Bolt: Using direct database aggregation for sequence numbers instead
        # of loading all models into memory prevents N+1-like array indexing inefficiencies.
        result = await self._session.execute(
