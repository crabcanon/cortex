...
class DocumentArtifactRepository:
    ...
    def add_many(self, records: Sequence[DocumentArtifactRecord]) -> None:
        models = [
            DocumentArtifactModel(
                document_id=record.document_id,
...
class DocumentTagRepository:
    ...
    def add_many(self, records: Sequence[DocumentTagRecord]) -> None:
        models = [
            DocumentTagModel(
                document_id=record.document_id,
                tag=record.tag,
...
class DocumentChunkRepository:
    ...
    def add_many(self, records: Sequence[DocumentChunkRecord]) -> None:
        models = [
            DocumentChunkModel(
...
class ParseRunAttemptRepository:
    ...
    def add_many(self, records: Sequence[ParseRunAttemptRecord]) -> None:
        models = [
            ParseRunAttemptModel(
                parse_run_id=record.parse_run_id,
