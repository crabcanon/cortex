...
def _cognee_stable_data_id(
    *,
    ...
    source_parts = [
        ...
        _strip_optional_string(metadata.get("source_url")) or "" if metadata else "",
        _strip_optional_string(metadata.get("source_name")) or "" if metadata else "",
        _strip_optional_string(metadata.get("engine_id")) or "" if metadata else "",
        _strip_optional_string(metadata.get("object_id")) or "" if metadata else "",
        _strip_optional_string(metadata.get("document_id")) or "" if metadata else "",
        _strip_optional_string(metadata.get("markdown_sha256")) or "" if metadata else "",
