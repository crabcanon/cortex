...
class JobEventRepository:
    ...
    # Prevents fetching potentially 1000s of rows into memory just to get the max sequence number
    # Time complexity: O(1) via SQL aggregation vs O(n) memory allocation
