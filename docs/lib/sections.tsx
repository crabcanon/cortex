...
export const apiReferenceSection = createSection({
  source: apiReferenceSource,
  contentDir: 'content/api-reference',
  getMarkdownUrl: (page) => getPageMarkdownUrl(page, apiReferenceSource).url,
  showContributors: true,
});

export const examplesSection = createSection({
  source: examplesSource,
  contentDir: 'content/examples',
  getMarkdownUrl: (page) => getPageMarkdownUrl(page, examplesSource).url,
  showContributors: true,
});
