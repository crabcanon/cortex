...
import RootProviderWithI18n from '@/src/components/RootProviderWithI18n';
...
const analyticsDomain = new URL(siteUrl).hostname;
const showAskAIWidget = false;
      ...
      <head>
        ...
        */}
        ...
        {/*
          ...
          API, which renamed several of the legacy attributes used by
          the previous docs site:
        ...
        */}
        {/*
          ...
          that matches the rest of the Cortex site (buttons,
